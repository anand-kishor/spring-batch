...
public class Demo10 {
	...
	@Bean Job demoJob()
	{
		return this.jobBuilderFactory.get("demo10").start(stepDemo1()).build();
	}
	@Bean
	 ...
	 * @Bean
	 * 
	 * @StepScope public FlatFileItemReader<EmployeeDTO> employeeReader() { // TODO
	 * Auto-generated method stub FlatFileItemReader<EmployeeDTO> reader=new
