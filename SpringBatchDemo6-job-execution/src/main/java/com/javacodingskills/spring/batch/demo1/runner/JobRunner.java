...
public class JobRunner {
	...
	@Autowired
	public JobRunner(JobLauncher jobLauncher, Job demo6,ExecutionContext executionContext) {
	...
	public void runBatchJob()
	{
		...
		executionContext.putString("employeeCsvFile", "employees.csv");
		runJob(demo6,builder.toJobParameters());
	}

	private void runJob(Job demo6, JobParameters jobParameters) {
		// TODO Auto-generated method stub//
		try {
			JobExecution execution=jobLauncher.run(demo6,jobParameters);
